...
const AdminSidebar = () => {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 shrink-0 border-r border-border bg-card flex flex-col transition-transform duration-200 md:static md:h-full md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`} >
